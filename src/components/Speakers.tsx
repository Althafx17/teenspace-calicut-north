...
const speakers = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=350&h=350',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=350&h=350',
    socials: { youtube: '#', globe: '#', mail: 'mailto:saleem@example.com' },
  },
  {
    name: 'Rashid Gazali',
    role: 'Student Counselor & Coach',
    bio: 'Renowned counselor specializing in youth leadership, behavior guidance, and career planning.',
    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=350&h=350',
    socials: { youtube: '#', globe: '#', mail: 'mailto:rashid@example.com' },
  },
  {
    name: 'Haris Ibn Saleem',
