...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative bg-white overflow-hidden border-b border-[#e5e7eb] py-12 lg:py-20">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-pink-100/40 via-sky-50/50 to-transparent rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        {/* Countdown Grid (4 Cards with Cyan Accent Bar) */}
